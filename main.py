...
# Sets choice_a random variable before the game starts replacing choice_a
# with choice_b if the player gets the answer right.
    choice_a = random_int()

# Makes sure the plaer can keep guessing, while loop will stop when
# end_game = True. Which means the player supplied a wrong answer
    while not end_game:
        clear()
        print(art.logo)
        if score > 0:
    ...
    # print choice_b values
        print(
            ...
            ", " +
            "a " +
            data[choice_a]["description"] +
            ", from" +
            data[choice_a]["country"] +
            ".")
        ...
        # Assign random integer to call a dictionary value for choice_b. Make
        # sure       #it's not the same as choice_a interger
        choice_b = random_int()
        ...
        print(
            ...
            ", " +
            "a " +
            data[choice_b]["description"] +
            ", " +
            "from " +
            data[choice_b]["country"] +
            ".")
